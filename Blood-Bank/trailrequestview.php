...
$number = mysqli_real_escape_string($conn,$_POST['no']);
 ...
 $sql=$conn->query("UPDATE request_registration SET action='Dispatched' WHERE first_name='$fname' and no='$number'and bloodgroup='$bg'");
  ...
  .menu a:hover{text-decoration:underline;}
   ...
   BLOOD BANK MANAGEMENT SYSTEM
     ...
     <div class="menu" style="">
       ...
       <a href="trailrequest.php">Request</a>
...
$conn=new mysqli($servername,$username,$password,$db);
       ...
       $sql="SELECT * from request_registration order by request_id";
 $res = mysqli_query($conn, $sql);
         ...
         <form action="trailrequestview.php" method="post">
